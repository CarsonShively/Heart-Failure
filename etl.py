...
DATASET_REPO_ID = "Carson-Shively/heart-failure"
REVISION        = "main" 
EXPORT_REL      = "gold.heart_failure"
LOCAL_FILE      = pathlib.Path("data/gold/gold_hf.parquet")
PATH_IN_REPO    = "data/gold/gold_hf.parquet"

BRONZE_SQL_PKG  = "heart_failure.data_layers.bronze"
SILVER_SQL_PKG  = "heart_failure.data_layers.silver"
GOLD_SQL_PKG    = "heart_failure.data_layers.gold"
